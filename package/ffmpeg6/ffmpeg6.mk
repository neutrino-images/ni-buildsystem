...
FFMPEG6_VERSION = 6.1.1
FFMPEG6_DIR = ffmpeg-$(FFMPEG6_VERSION)
FFMPEG6_SOURCE = ffmpeg-$(FFMPEG6_VERSION).tar.xz
FFMPEG6_SITE = http://www.ffmpeg.org/releases

FFMPEG6_DEPENDENCIES = openssl zlib bzip2 harfbuzz freetype rtmpdump libbluray libass libxml2 libvorbis alsa-lib
...
ifeq ($(BS_PACKAGE_FFMPEG6_FFPLAY),y)
  ...
  FFMPEG6_CONF_ENV += SDL_CONFIG=$(HOST_DIR)/bin/sdl2-config
else
  FFMPEG6_CONF_OPTS += --disable-ffplay
endif

ifeq ($(BS_PACKAGE_FFMPEG6_FFPROBE),y)
  FFMPEG6_CONF_OPTS += --enable-ffprobe
else
  FFMPEG6_CONF_OPTS += --disable-ffprobe
endif

FFMPEG6_DEPENDENCIES += lame
FFMPEG6_CONF_OPTS += --enable-libmp3lame
