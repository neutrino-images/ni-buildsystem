...
#COOLSTREAM_DRIVERS_DEPENDENCIES = kernel # because of $(LINUX_RUN_DEPMOD)

define COOLSTREAM_DRIVERS_INSTALL_MODULES
	$(INSTALL) -d $(TARGET_modulesdir)
	$(INSTALL_COPY) $($(PKG)_BUILD_DIR)/$(DRIVERS_BIN_DIR)/lib-modules/$(KERNEL_VERSION)/. $(TARGET_modulesdir)
endef
