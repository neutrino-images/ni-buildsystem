...
define COOLSTREAM_LIBS_INSTALL_MODULES
	...
	$(INSTALL_COPY) $(PKG_BUILD_DIR)/$(DRIVERS_BIN_DIR)/lib/. $(TARGET_libdir)
	$(INSTALL_COPY) $(PKG_BUILD_DIR)/$(DRIVERS_BIN_DIR)/libcoolstream/$(shell echo -n $(BS_PACKAGE_FFMPEG2_BRANCH) | sed 's,/,-,g')/. $(TARGET_libdir)
endef
