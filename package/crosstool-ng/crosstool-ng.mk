...
CROSSTOOL_NG_BUILD_CONFIG = $($(PKG)_BUILD_DIR)/.config
...
define CROSSTOOL_NG_DOWNLOAD_LINARO_4_9
	$(call DOWNLOAD,$(GCC_LINARO_SITE),$(GCC_LINARO_SOURCE))
endef
...
define CROSSTOOL_NG_INSTALL_PATCHES
	$(INSTALL_COPY) $(PKG_PATCHES_DIR)/$(CROSSTOOL_NG_VERSION)-gcc/* \
		$($(PKG)_BUILD_DIR)/patches/gcc/linaro-$(GCC_LINARO_VERSION)
endef
