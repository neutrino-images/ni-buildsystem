...
ifeq ($(BOXSERIES),$(filter $(BOXSERIES),hd2 hd5x hd6x vusolo4k vuduo4k vuduo4kse vuultimo4k vuzero4k vuuno4k vuuno4kse vuduo))
  ...
  define BUSYBOX_SET_SYSLOGD_CFG
	$(call KCONFIG_ENABLE_OPT,CONFIG_FEATURE_SYSLOGD_CFG)
  endef
  define BUSYBOX_INSTALL_SYSLOG_CONF
	$(INSTALL_DATA) -D $(PKG_FILES_DIR)/syslog.conf $(TARGET_sysconfdir)/syslog.conf
  endef
  BUSYBOX_TARGET_FINALIZE_HOOKS += BUSYBOX_INSTALL_SYSLOG_CONF
